...
export const REVIEWS = [
  {
    heading: "സുഗന്ധവ്യഞ്ജനങ്ങൾ മാത്രമല്ല",
    sub: "മില്ലറ്റുകൾ, തേൻ, വിത്തുകൾ & ആരോഗ്യ ഉൽപ്പന്നങ്ങൾ",
    desc: "സുഗന്ധമുള്ള കേരള സുഗന്ധവ്യഞ്ജനങ്ങൾ മുതൽ പോഷകസമൃദ്ധമായ മില്ലറ്റുകൾ, ഓർഗാനിക് തേൻ, ചിയ വിത്തുകൾ, തേങ്ങ എള്ളുരുണ്ട, ലെമൺഗ്രാസ് ഓയിൽ എന്നിവ വരെ — പ്രകൃതിദത്തവും ഫാം ഫ്രഷുമായ ഒരു സമ്പൂർണ്ണ ശ്രേണി ഞങ്ങൾ നിങ്ങൾക്ക് നൽകുന്നു.",
    hashtags: ["#മില്ലറ്റുകൾ", "#ഓർഗാനിക്_തേൻ", "#വിത്തുകൾ", "#ഡ്രൈ_ഫ്രൂട്ട്സ്", "#ആരോഗ്യ_ഉൽപ്പന്നങ്ങൾ"],
    button: { label: "ഞങ്ങളുടെ ശേഖരം കണ്ടെത്തൂ", href: "#gallery" },
  },
  {
    heading: "ഞങ്ങളുടെ ലോകത്തിലേക്ക് ഒരു എത്തിനോട്ടം",
    sub: "ഫാമിൽ നിന്ന് നേരിട്ട് സ്റ്റോറിലേക്ക്",
    desc: "ഞങ്ങളുടെ ഷെൽഫുകൾ നിറയ്ക്കുന്നത് എന്തെല്ലാമെന്ന് നോക്കൂ — മുള അരി, റാഗി, പേൾ മില്ലറ്റ്, സ്പൈസ് ഗിഫ്റ്റ് ബോക്സ്, കാപ്പിപ്പൊടി എന്നിങ്ങനെ കേരളത്തിന്റെ ഹൃദയഭാഗത്ത് നിന്നുള്ള നിരവധി പ്രകൃതിദത്ത ഖനിജങ്ങൾ.",
  },
  {
    heading: "ശുദ്ധവും ഓർഗാനികും, എല്ലായ്പ്പോഴും",
    sub: "കൃത്രിമം ഇല്ല · കീടനാശിനി ഇല്ല · 100% പ്രകൃതിദത്തം",
    desc: "സുഗന്ധവ്യഞ്ജനങ്ങളോ മില്ലറ്റുകളോ തേനോ വിത്തുകളോ — ഞങ്ങൾ നൽകുന്ന ഓരോ ഉൽപ്പന്നവും 100% ഓർഗാനിക്, രാസവസ്തുക്കളില്ലാത്തതും കേരളത്തിലെ വിശ്വസനീയമായ ഫാമുകളിൽ നിന്ന് നേരിട്ട് ശേഖരിച്ചതുമാണ്.",
  },
];